...
function Output($name='', $dest='')
{
	...
	switch($dest)
	{
		case 'I':
			...
			if(ob_get_length())
				$this->Error('Ya existe, no puede enviar el archivo de PDF');
		...
		case 'F':
			...
			$f=fopen($name,'wb');
			if(!$f)
				$this->Error('Incapaz de crear el archivo de salida: '.$name);
		...
		case 'S':
			...
			return $this->buffer;
		default:
			$this->Error('Destino de salida incorrecto: '.$dest);
	}
	return '';
}
