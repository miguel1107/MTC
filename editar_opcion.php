...
<body>
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="8" bgcolor="#B1D6E5">
  <tbody>
    <tr>
      <td  valign="top"><form name="form1" method="post" action="update_opcion.php" onSubmit="return validar(this)">
        <table class="frmline" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
          <tbody>
            <tr>
            ...
            <tr valign="middle">
              <td height="9" colspan="3"><table width="100%" border="1" align="center" cellpadding="1" cellspacing="1">
                <?php
$sql2="SELECT * FROM postulante p INNER JOIN tramite t ON p.idpostulante=t.idpostulante INNER JOIN categoria c ON t.idcategoria=c.idcategoria INNER JOIN evaluacion e ON e.idtramite=t.idtramite where t.idtramite=".$_GET["idttra"]." and e.fecha='".$_GET["fecha"]."'"; 
