...
///////////////////
	if ($_POST["tipotra"]=='NUEVO' || $_POST["tipotra"]=='RECATEGORIZACION' || $_POST["tipotra"]=='CANJE RECATEGORIZACION' || $_POST["tipotra"]=='REVALIDACION' || $_POST["tipotra"]=='CANJE REVALIDACION'){
 		if($_POST["sw"]!=3){
 ...
 //////////////////
if(isset($realizar)){ //inicio de para ver si existe la variable
//////////////////////////////////////////////
	if($_POST["sw"]!=3){
...
/////////////////////////////////////////////////////////////////////
		...
		if(pg_num_rows($record) > 0)
		{
		  ...
		  if($_POST["tipotra"]!='DUPLICADO'  || $_POST["tipotra"]=='CANJE POR MODIFICACION'){
...
///////////////////////////////////////////////////////
		  $sql="insert into postulante (nombres,apepat,apemat,fecnac,edad,profesion,estadocivil,dni,lm,ce,ci,sexo,estatura,domicilio) values('".$_POST["txtnom"]."','".$_POST["apepat"]."','".$_POST["apemat"]."','".$_POST["fefe"]."','".$_POST["edad"]."','".$_POST["profe"]."','".$_POST["estadocivil"]."','".$_POST["dni"]."','".$_POST["lm"]."','".$_POST["ce"]."','".$_POST["ci"]."','".$_POST["sexo"]."','".$_POST["estatura"]."','".$_POST["direccion"]."')";
