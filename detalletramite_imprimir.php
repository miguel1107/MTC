...
$link=Conectarse();
	...
	$this->Cell(190,1,'Firma del Coordinador de Licencias',0,0,'R',0);
	$this->Cell(-4,-12,'________________________',0,0,'R',0);
}
}
//$pdf=new FPDF();
$pdf=new PDF();
...
$pdf->Cell(35,5,$fila2[25],1,1,'C',1);
$pdf->SetXY(40,207);
...
$pdf->Cell(26,5,$fila2[10],0,0,'L',1);
...
$pdf->Cell(25,7,'',1,0,'C',1);
$pdf->Cell(5,7,'',0,0,'C',0);
$pdf->Cell(47,-15,'________________________',0,0,'R',0);
$pdf->SetXY(155,250);
