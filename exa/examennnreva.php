   ...
   ?>
    ...
    <tr>
      <td colspan="3"><table width="100%" border="0" bgcolor="#B1D6E5">
        <tr>
          <td width="5%" valign="top"><?=$i?><? //=$reg[0]?>.-</td>
		...
		<? if($reg[6]!=''){?> 
         ...
         <tr>
          ...
          <td width="5%" valign="top"><span class="Estilo4">
            (<?=$reg5[0]?>)
          </span></td>
          <td width="83%" valign="top"><span class="Estilo4">
            <?=$reg5[2]?>
          </span></td>
          <td><input name="wilfredo" type="hidden" value="<?=$reg5[1]?>"></td>
          </tr>
  <? }?>
      </table></td>
    </tr><? }}?>
