	...
	if($_POST["resultado".$num.""]!="" ) 
		{
			...
			$sql2="update evaluacion set resultado='".$_POST["resultado".$num.""]."'
			where fecha='".$_POST["fechaexamen"]."' and idexamen='".$_POST["categoria"]."' and idtramite= '".$_POST["post".$num.""]."'";
			}else{
			$sql2="update evaluacion set resultado='".$_POST["resultado".$num.""]."'
			where fecha='".$_POST["fechaexamen"]."' and idexamen='".$_POST["tipocate".$num.""]."' and idtramite= '".$_POST["post".$num.""]."'";
			}
